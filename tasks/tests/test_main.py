...
def test_allocate_parking_car_available():
...
def test_allocate_parking_car_unavailable():
...
def test_allocate_parking_motorbike_available():
...
def test_allocate_parking_motorbike_unavailable():
    parking_lot = ParkingLot(0, 0, 0)
    vehicle_number = "XYZ456"
    entry_time = datetime.datetime.now()
    spot_number = parking_lot.allocate_parking("motorbike", vehicle_number, entry_time)
...
def test_allocate_parking_bus_available():
...
def test_allocate_parking_bus_unavailable():
    parking_lot = ParkingLot(0, 0, 0)
    vehicle_number = "123BUS"
    entry_time = datetime.datetime.now()
    spot_number = parking_lot.allocate_parking("bus", vehicle_number, entry_time)
...
def test_allocate_parking_invalid_vehicle_type():
    parking_lot = ParkingLot(0, 0, 0)
    vehicle_number = "ABC123"
    entry_time = datetime.datetime.now()
...
def test_calculate_fare_motorbike():
    parking_lot = ParkingLot(0, 1, 0)
    vehicle_number = "XYZ456"
...
def test_calculate_fare_invalid_vehicle_type():
    parking_lot = ParkingLot(0, 0, 0)
    fare = parking_lot.calculate_fare(1, "invalid", datetime.datetime.now())
    assert fare == -1

def test_calculate_fare_invalid_spot_number():
    parking_lot = ParkingLot(1, 0, 0)
    fare = parking_lot.calculate_fare(2, "car", datetime.datetime.now())
    assert fare == 0

def test_get_parking_spot_car_exists():
    parking_lot = ParkingLot(1, 0, 0)
    vehicle_number = "ABC123"
    entry_time = datetime.datetime.now()
    spot_number = parking_lot.allocate_parking("car", vehicle_number, entry_time)
...
def test_get_parking_spot_car_not_exists():
    parking_lot = ParkingLot(1, 0, 0)
    vehicle_number = "ABC123"
    entry_time = datetime.datetime.now()
...
def test_get_parking_spot_motorbike_exists():
    parking_lot = ParkingLot(0, 1, 0)
    vehicle_number = "XYZ456"
    entry_time = datetime.datetime.now()
    spot_number = parking_lot.allocate_parking("motorbike", vehicle_number, entry_time)
...
def test_get_parking_spot_motorbike_not_exists():
    parking_lot = ParkingLot(0, 1, 0)
    vehicle_number = "XYZ456"
    entry_time = datetime.datetime.now()
...
def test_get_parking_spot_bus_exists():
    parking_lot = ParkingLot(0, 0, 1)
    vehicle_number = "123BUS"
    entry_time = datetime.datetime.now()
    spot_number = parking_lot.allocate_parking("bus", vehicle_number, entry_time)
...
def test_get_parking_spot_bus_not_exists():
    parking_lot = ParkingLot(0, 0, 1)
    vehicle_number = "123BUS"
    entry_time = datetime.datetime.now()
...
def test_multiple_cars_allocate_and_exit():
...
def test_multiple_motorbikes_allocate_and_exit():
...
def test_multiple_buses_allocate_and_exit():
...
def test_allocate_parking_and_exit_sequential():
...
def test_allocate_parking_exit_car_motorbike():
...
def test_allocate_parking_exit_motorbike_bus():
...
def test_allocate_parking_exit_bus_car():
...
def test_allocate_parking_no_capacity():
    parking_lot = ParkingLot(0, 0, 0)
    vehicle_number = "ABC123"
    entry_time = datetime.datetime.now()
    spot_number = parking_lot.allocate_parking("car", vehicle_number, entry_time)
...
def test_calculate_fare_invalid_spot_number_car():
    parking_lot = ParkingLot(1, 0, 0)
    fare = parking_lot.calculate_fare(2, "car", datetime.datetime.now())
    assert fare == 0

def test_calculate_fare_invalid_spot_number_motorbike():
    parking_lot = ParkingLot(0, 1, 0)
    fare = parking_lot.calculate_fare(2, "motorbike", datetime.datetime.now())
    assert fare == 0

def test_calculate_fare_invalid_spot_number_bus():
    parking_lot = ParkingLot(0, 0, 1)
    fare = parking_lot.calculate_fare(2, "bus", datetime.datetime.now())
    assert fare == 0

def test_get_parking_spot_invalid_vehicle_number_car():
    parking_lot = ParkingLot(1, 0, 0)
    vehicle_number = "ABC123"
    entry_time = datetime.datetime.now()
    parking_lot.allocate_parking("car", vehicle_number, entry_time)
...
def test_get_parking_spot_invalid_vehicle_number_motorbike():
    parking_lot = ParkingLot(0, 1, 0)
    vehicle_number = "XYZ456"
    entry_time = datetime.datetime.now()
    parking_lot.allocate_parking("motorbike", vehicle_number, entry_time)
...
def test_get_parking_spot_invalid_vehicle_number_bus():
    parking_lot = ParkingLot(0, 0, 1)
    vehicle_number = "123BUS"
    entry_time = datetime.datetime.now()
    parking_lot.allocate_parking("bus", vehicle_number, entry_time)
...
def test_multiple_cars_allocate_no_capacity():
...
def test_multiple_motorbikes_allocate_no_capacity():
...
def test_multiple_buses_allocate_no_capacity():
...
def test_allocate_parking_exit_car_invalid_spot_number():
    parking_lot = ParkingLot(1, 0, 0)
    vehicle_number = "ABC123"
    entry_time = datetime.datetime.now()
    spot_number = parking_lot.allocate_parking("car", vehicle_number, entry_time)
...
def test_allocate_parking_exit_motorbike_invalid_spot_number():
    parking_lot = ParkingLot(0, 1, 0)
    vehicle_number = "XYZ456"
    entry_time = datetime.datetime.now()
    spot_number = parking_lot.allocate_parking("motorbike", vehicle_number, entry_time)
...
def test_allocate_parking_exit_bus_invalid_spot_number():
    parking_lot = ParkingLot(0, 0, 1)
    vehicle_number = "123BUS"
    entry_time = datetime.datetime.now()
    spot_number = parking_lot.allocate_parking("bus", vehicle_number, entry_time)
...
def test_get_parking_spot_multiple_cars():
...
def test_get_parking_spot_multiple_motorbikes():
...
def test_get_parking_spot_multiple_buses():
...
def test_allocate_parking_exit_car_same_spot_number():
    parking_lot = ParkingLot(2, 0, 0)
...
def test_allocate_parking_exit_motorbike_same_spot_number():
    parking_lot = ParkingLot(0, 2, 0)
    vehicle_number1 = "ABC123"
    vehicle_number2 = "ABC456"
    entry_time = datetime.datetime.now()
...
def test_allocate_parking_exit_bus_same_spot_number():
    parking_lot = ParkingLot(0, 0, 2)
...
def test_allocate_parking_exit_car_multiple_spots():
    parking_lot = ParkingLot(3, 0, 0)
...
def test_allocate_parking_exit_motorbike_multiple_spots():
    parking_lot = ParkingLot(0, 3, 0)
...
def test_allocate_parking_exit_bus_multiple_spots():
    parking_lot = ParkingLot(0, 0, 3)
